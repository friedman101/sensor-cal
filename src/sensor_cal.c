...
#define PACK_MATS \
A[0][0] = a1; A[0][1] = 0; A[0][2] = 0; \
A[1][0] = a2; A[1][1] = a3; A[1][2] = 0; \
A[2][0] = a4; A[2][1] = a5; A[2][2] = a6; \
...
a2 = gsl_matrix_get(B, 1, 0); \
a3 = gsl_matrix_get(B, 2, 0); \
a4 = gsl_matrix_get(B, 3, 0); \
a5 = gsl_matrix_get(B, 4, 0); \
a6 = gsl_matrix_get(B, 5, 0); \
b1 = gsl_matrix_get(B, 6, 0); \
b2 = gsl_matrix_get(B, 7, 0); \
b3 = gsl_matrix_get(B, 8, 0);


double calc_residual(double (*x)[3], unsigned int x_len,
        double x_mag, gsl_matrix *B, gsl_matrix *residual) {
...
unsigned int cal(double (*x)[3], unsigned int x_len,
    ...
    for (j = 0; j < max_iter; j++) {
        double e = calc_residual(x, x_len, x_mag, B, residual);
